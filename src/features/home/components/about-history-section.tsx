                    ...
                    <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
                        <div className="relative max-w-lg mx-auto lg:max-w-none">
                            <div className="relative z-10 rounded-3xl md:rounded-[3rem] overflow-hidden shadow-2xl aspect-[4/3] lg:aspect-auto">
                                <Image src={content.about.imageUrl} alt="School History" width={600} height={500} className="object-cover w-full h-full lg:h-[500px]" />
                            </div>
                    ...
                    <div className="w-full lg:w-1/2 px-4 lg:pl-16">
                        <div className="flex flex-col items-center lg:items-start">
                            ...
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-8 leading-tight text-center lg:text-left">
                                {content.about.title} <span className="text-blue-600">{content.about.titleHighlight}</span>
                            </h2>
                            <div className="space-y-6 text-gray-600 text-base md:text-lg leading-relaxed text-center lg:text-left">
                                ...
                                <div className="pt-8 grid grid-cols-2 gap-4 md:gap-8 max-w-md mx-auto lg:mx-0">
                                    <div className="bg-gray-50 p-4 md:p-0 md:bg-transparent rounded-2xl md:rounded-none">
                                        <div className="text-2xl md:text-3xl font-bold text-blue-600 mb-1">{content.about.stat1Value}</div>
                                        <div className="text-[10px] md:text-sm font-bold text-gray-500 uppercase tracking-wider">{content.about.stat1Label}</div>
                                    </div>
                                    <div className="bg-gray-50 p-4 md:p-0 md:bg-transparent rounded-2xl md:rounded-none">
                                        <div className="text-2xl md:text-3xl font-bold text-blue-600 mb-1">{content.about.stat2Value}</div>
                                        <div className="text-[10px] md:text-sm font-bold text-gray-500 uppercase tracking-wider">{content.about.stat2Label}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
