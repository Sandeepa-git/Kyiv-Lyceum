      ...
      <div className="container px-4 mx-auto">
        <div className="flex flex-wrap -mx-4 mb-12">
          ...
          <div className="w-full lg:w-1/2 px-4 mb-12 lg:mb-0">
            ...
            <div className="space-y-2 text-sm text-gray-500">
              <p className="font-bold text-gray-700">{content.contact.director}</p>
              <p>{content.contact.address}</p>
              <p>EDRPOU code {content.contact.edrpouCode}</p>
              <p>IBAN {content.contact.iban}</p>
              <p>{content.contact.bank}</p>
              <div className="flex space-x-4 mt-4">
                <a href={`tel:${content.contact.phone.replace(/[^+\d]/g, '')}`} className="text-blue-600 hover:underline">{content.contact.phone}</a>
                <a href={`mailto:${content.contact.email}`} className="text-blue-600 hover:underline">{content.contact.email}</a>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li><a href={content.contact.telegramUrl} className="text-gray-500 hover:text-blue-600">Telegram Support</a></li>
                  <li><a href={content.contact.viberUrl} className="text-gray-500 hover:text-blue-600">Viber Chat</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex space-x-6">
            <a href={content.footer.facebookUrl} className="p-2 text-gray-400 hover:text-blue-600 transition-colors" aria-label="Facebook">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
            </a>
            <a href={content.footer.instagramUrl} className="p-2 text-gray-400 hover:text-blue-600 transition-colors" aria-label="Instagram">
            ...
            <a href={content.footer.telegramUrl} className="p-2 text-gray-400 hover:text-blue-600 transition-colors" aria-label="Telegram">
